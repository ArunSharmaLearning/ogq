	...
	return (
		<Box component={"main"}>
			...
			<Container>
				...
				<Typography variant="h6" sx={{ textAlign: 'center', mt: 2 }}>It takes just 6 grams of Gold to lift the worth of a nation. Come Join Us in our quest for GOLD!</Typography>
			</Container>
		</Box>
	);
};
