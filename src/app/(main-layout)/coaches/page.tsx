...
const CoachesProgram = () => {
	...
	const { data: vision, isLoading: visionLoading } = useAPI("vision", 2);

	const { data: mission, isLoading: missionLoading } = useAPI("mission", 2);

	const { data: history, isLoading: historyLoading } = useAPI("history", 2);
