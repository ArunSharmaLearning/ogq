...
export default function Home() {
  ...
  return (
    <>
      ...
      <Container>
        <Box sx={{ paddingTop: 7 }}>
          <Typography className="underlineAfter" variant="h1" sx={{ mb: 4 }}>
            Leading Sports NGO in India Supporting Talent & Creating Impact
          </Typography>
        ...
        <Box sx={{ mt: 3 }}>
          ...
          <Typography variant="body1" sx={{ mt: 3, mb: 10 }}>
